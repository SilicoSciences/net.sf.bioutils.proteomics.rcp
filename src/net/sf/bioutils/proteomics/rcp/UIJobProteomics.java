...
public abstract class UIJobProteomics extends UIJob {

    private final static Logger log = LoggerFactory.getLogger(UIJobProteomics.class);

    private final String pluginId;

    public UIJobProteomics(final String pluginId) {
        super("update UI");
